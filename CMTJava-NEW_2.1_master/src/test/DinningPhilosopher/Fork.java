...
class Fork implements TObject{
	...
	private Conteiner<Boolean> fork = new Conteiner<Boolean> ();
private FieldInfo<Boolean> forkFieldInfo = new FieldInfo<Boolean> ("fork", (Boolean a) -> {fork.setConteudo(a); return null;});
